...
if (!in_array($admin_nivel_acesso_logado, $niveis_acesso_ver_tabelas) && !in_array($admin_nivel_acesso_logado, $niveis_acesso_ver_eventos_diario)) {
    $_SESSION['admin_error_message'] = "Você não tem permissão para acessar a seção de gerenciamento de locais.";
    header('Location: index.php');
    exit;
}

$page_title = 'Gerenciamento de Locais';
require_once 'admin_header.php'; // Inclui o layout do painel

// Definição dos blocos para esta página HUB
$blocos_hub = [
    [
        'titulo' => 'Gerenciar Locais Escalas',
        'link' => 'locais_listar.php', // Página que lista os blocos
        ...
        'descricao' => 'Cadastre, edite e gerencie os locais que aparecerão na página da escala.'
    ],
    [
        'titulo' => 'Gerenciar Locais Diário de Bordo',
        'link' => 'locais_diario_listar.php', // Página inicial para pesquisar um Bloco antes de gerenciar seus eventos
        ...
        'descricao' => 'Edite e gerencie os locais que aparecerão nos Diários de Bordo.'
    ],
];
...
<p class="lead">
    Esta seção permite o gerenciamento dos Locais que aparecerão na Escala e nos Diários de Bordo.
</p>
